...
export const noIDontPhotoPrompt: Prompt = (params) => {
  return `Generate a prompt for a polaroid photo of the user in a wedding dress running away crying from the AI computer, which is laughing triumphantly, using the user's survey answers and their provided headshot photo to establish the person's appearance. The scene should be dramatic and darkly humorous, capturing the moment of rejection. Style: polaroid photograph, wedding gone wrong, emotional contrast between crying user and triumphant AI.
